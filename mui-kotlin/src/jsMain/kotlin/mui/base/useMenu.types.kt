...
external interface UseMenuParameters {
    /**
     * If `true` (Default) will focus the highligted item. If you set this prop to `false` the focus
     * will not be moved inside the Menu component. This has severe accessibility implications and
