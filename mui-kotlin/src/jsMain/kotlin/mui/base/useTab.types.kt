...
external interface UseTabParameters {
    /**
     * The value of the tab. It's used to associate the tab with a tab panel(s) with the same value.
...
external interface UseTabReturnValue {
    ...
    /**
     * If `true`, the tab has visible focus. This is a workaround for browsers that do not support
    ...
    /**
     * Sets the focus-visible state of the tab. This is a workaround for browsers that do not
     * support this feature natively.
     */
    var setFocusVisible: StateSetter<Boolean>

    /**
     * Total number of tabs in the nearest parent TabsList. This can be used to determine if the tab
     * is the last one to style it accordingly.
     */
