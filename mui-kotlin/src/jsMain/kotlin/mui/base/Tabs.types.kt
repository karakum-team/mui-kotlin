...
external interface TabsProps : TabsOwnProps, HTMLAttributes<HTMLDivElement>

external interface TabsOwnProps : PropsWithChildren, PropsWithClassName {
    ...
    /**
     * The components used for each slot inside the Tabs. Either a string to use a HTML element or a
     * component.
     *
     * @default {}
     */
