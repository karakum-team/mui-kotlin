...
external interface PopperProps : PopperOwnProps, HTMLAttributes<HTMLDivElement>
...
external interface PopperOwnProps : PropsWithChildren {
    /**
     * An HTML element, [virtualElement](https://popper.js.org/docs/v2/virtual-elements/), or a
     * function that returns either. It's used to set the position of the popper. The return value
     * will passed as the reference object of the Popper instance.
     */
    var anchorEl:
        Any? /* null | VirtualElement | HTMLElement | (() => HTMLElement) | (() => VirtualElement) */

    /** Popper render function or node. */
    override var children:
        ReactNode? /* React.ReactNode | ((props: PopperChildrenProps) => React.ReactNode) */
     ...
     * want to maximize the responsiveness of the Popper.
     *
     * @default false
     */
    ...
    /**
     * Popper.js is based on a "plugin-like" architecture, most of its features are fully
     * encapsulated "modifiers".
     *
     * A modifier is a function that is called each time Popper.js needs to compute the position of
     * the popper. For this reason, modifiers should be very performant to avoid bottlenecks. To
     * learn how to create a modifier,
     * [read the modifiers documentation](https://popper.js.org/docs/v2/modifiers/).
     */
    ...
    /**
     * Options provided to the [`Popper.js`](https://popper.js.org/docs/v2/constructors/#options)
     * instance.
     *
     * @default {}
     */
    ...
    /**
     * The components used for each slot inside the Popper. Either a string to use a HTML element or
     * a component.
     *
     * @default {}
     */
