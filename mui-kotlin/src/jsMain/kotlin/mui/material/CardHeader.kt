...
external interface CardHeaderProps :
    CardHeaderOwnProps, CardHeaderSlotsAndSlotProps, HTMLAttributes<HTMLDivElement>
...
external interface CardHeaderSlots {
     ...
     * [Follow this guide](https://mui.com/material-ui/api/typography/#props) to learn more about
...
external interface CardHeaderOwnProps : PropsWithSx, HTMLAttributes<HTMLDivElement> {
    ...
    /**
     * If `true`, `subheader` and `title` won't be wrapped by a Typography component. This can be
     * useful to render an alternative Typography variant by wrapping the `title` text, and optional
 ...
 */
@JsName("default") external val CardHeader: FC<CardHeaderProps>
