...
external interface SlideProps : TransitionProps, PropsWithChildren {
    /**
    ...
    /**
     * An HTML element, or a function that returns one. It's used to set the container the Slide is
     * transitioning from.
     */
...
/**
 * The Slide transition is used by the [Drawer](https://mui.com/material-ui/react-drawer/)
 * component.
 *
 * Demos:
 *
 ...
 */
@JsName("default") external val Slide: FC<SlideProps>
