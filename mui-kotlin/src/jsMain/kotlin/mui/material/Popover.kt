...
external interface PopoverProps : StandardProps, ModalProps, PropsWithChildren, PropsWithSx {
    /** A ref for imperative actions. It currently only supports updatePosition() action. */
    var action: Ref<PopoverActions>?

    /**
     * An HTML element,
     * [PopoverVirtualElement](https://mui.com/material-ui/react-popover/#virtual-element), or a
     * function that returns either. It's used to set the position of the popover.
     */
    var anchorEl:
        Any? /* null | Element | PopoverVirtualElement | (() => Element | PopoverVirtualElement | null) */

    /**
     * This is the point on the anchor where the popover's `anchorEl` will attach to. This is not
     * used when the anchorReference is 'anchorPosition'.
     *
    ...
    /**
     * This is the position that may be used to set the position of the popover. The coordinates are
     * relative to the application's client area.
     */
    ...
    /**
     * An HTML element, component instance, or function that returns either. The `container` will
     * passed to the Modal component.
     *
     * By default, it uses the body of the anchorEl's top-level document object, so it's simply
    ...
    /**
     * Specifies how close to the edge of the window the popover can appear. If null, the popover
     * will not be constrained by the window.
     *
     * @default 16
     */
...
external interface PopoverSlotProps : Props {
    /**
     * TS: SlotProps<React.ElementType<ModalProps>, PopoverRootSlotPropsOverrides,
     * PopoverOwnerState>
     */
    var root: ModalProps?

    /**
     * TS: SlotProps<React.ElementType<PaperProps>, PopoverPaperSlotPropsOverrides,
     * PopoverOwnerState>
     */
     ...
     * PopoverTransitionSlotPropsOverrides, PopoverOwnerState>
     */
    var transition: Any?

    /**
     * TS: SlotProps<React.ElementType<BackdropProps>, PopoverBackdropSlotPropsOverrides,
     * PopoverOwnerState>
     */
 ...
 */
@JsName("default") external val Popover: FC<PopoverProps>
