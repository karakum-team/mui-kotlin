...
external interface TooltipProps :
    ...
    /**
     * Set to `true` if the `title` acts as an accessible description. By default the `title` acts
     * as an accessible label for the child.
     *
     * @default false
     */
    ...
    /**
     * Makes a tooltip not interactive, i.e. it will close when the user hovers over the tooltip
     * before the `leaveDelay` is expired.
     *
     * @default false
     */
    ...
    /**
     * The number of milliseconds to wait before showing the tooltip. This prop won't impact the
     * enter touch delay (`enterTouchDelay`).
     *
     * @default 100
     */
    var enterDelay: Int?
    ...
    /**
     * The number of milliseconds to wait before showing the tooltip when one was already recently
     * opened.
     *
     * @default 0
     */
    ...
    /**
     * The number of milliseconds to wait before hiding the tooltip. This prop won't impact the
     * leave touch delay (`leaveTouchDelay`).
     *
     * @default 0
     */
    var leaveDelay: Int?
    ...
    /**
     * The number of milliseconds after the user stops touching an element before hiding the
     * tooltip.
     *
     * @default 1500
     */
...
external interface TooltipSlotProps : Props {
    /**
     * TS: SlotProps<React.ElementType<PopperProps>, TooltipPopperSlotPropsOverrides,
     * TooltipOwnerState>
     */
    var popper: PopperProps?

    /**
     * TS: SlotProps<React.ElementType<TransitionProps>, TransitionProps &
     * TooltipTransitionSlotPropsOverrides, TooltipOwnerState>
     */
 ...
 */
@JsName("default") external val Tooltip: FC<TooltipProps>
