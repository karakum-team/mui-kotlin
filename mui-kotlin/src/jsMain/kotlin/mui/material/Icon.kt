...
external interface IconProps : IconOwnProps, HTMLAttributes<HTMLSpanElement>, PropsWithComponent

external interface IconOwnProps : PropsWithChildren, PropsWithSx {
    /**
     * The base class applied to the icon. Defaults to 'material-icons', but can be changed to any
     * other base class that suits the icon font you're using (for example material-icons-rounded,
     * fas, etc).
     *
 ...
 */
@JsName("default") external val Icon: FC<IconProps>
