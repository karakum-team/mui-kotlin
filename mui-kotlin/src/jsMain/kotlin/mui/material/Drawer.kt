...
external interface DrawerProps : StandardProps, ModalProps, PropsWithChildren, PropsWithSx {
    /**
...
external interface DrawerSlotProps : Props {
    ...
    /**
     * TS: SlotProps<React.ElementType<BackdropProps>, DrawerBackdropSlotPropsOverrides,
     * DrawerOwnerState>
     */
     ...
     * DrawerTransitionSlotPropsOverrides, DrawerOwnerState>
     */
...
/**
 * The props of the [Modal](https://mui.com/material-ui/api/modal/) component are available when
 ...
 */
@JsName("default") external val Drawer: FC<DrawerProps>
