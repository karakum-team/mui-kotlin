...
external interface TableSortLabelSlotProps : Props {
    /**
     * TS: SlotProps<React.ElementType<React.HTMLAttributes<HTMLSpanElement>>,
     * TableSortLabelRootSlotPropsOverrides, TableSortLabelOwnerState>
     */
    var root: Any?

    /**
     * TS: SlotProps<React.ElementType<React.SVGAttributes<SVGSVGElement>>,
     * TableSortLabelIconSlotPropsOverrides, TableSortLabelOwnerState>
     */
    var icon: Any?
}
...
external interface TableSortLabelOwnProps : PropsWithChildren, PropsWithSx {
    /**
 ...
 */
@JsName("default") external val TableSortLabel: FC<TableSortLabelProps>
