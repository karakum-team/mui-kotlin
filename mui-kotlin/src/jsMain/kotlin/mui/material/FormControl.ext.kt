...
sealed external interface FormControlColor {
    companion object {
        @JsValue("primary") val primary: FormControlColor
        @JsValue("secondary") val secondary: FormControlColor
        @JsValue("error") val error: FormControlColor
        @JsValue("info") val info: FormControlColor
        @JsValue("success") val success: FormControlColor
        @JsValue("warning") val warning: FormControlColor
    }
}
