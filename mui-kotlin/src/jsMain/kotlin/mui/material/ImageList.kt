...
external interface ImageListProps :
    ImageListOwnProps, HTMLAttributes<HTMLUListElement>, PropsWithComponent

external interface ImageListOwnProps : PropsWithChildren, PropsWithSx {
 ...
 */
@JsName("default") external val ImageList: FC<ImageListProps>
