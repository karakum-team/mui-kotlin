...
external interface ToggleButtonOwnProps : PropsWithChildren, PropsWithSx, ButtonBaseProps {
    ...
    /**
     * The color of the button when it is in an active state. It supports both default and custom
    ...
    /**
     * The size of the component. The prop defaults to the value inherited from the parent
 ...
 */
@JsName("default") external val ToggleButton: FC<ToggleButtonProps>
