...
external interface SkeletonProps :
    SkeletonOwnProps, HTMLAttributes<HTMLSpanElement>, PropsWithComponent

external interface SkeletonOwnProps : PropsWithChildren, PropsWithSx {
    /**
    ...
    /**
     * Width of the skeleton. Useful when the skeleton is inside an inline element with no width of
     * its own.
     */
 ...
 */
@JsName("default") external val Skeleton: FC<SkeletonProps>
