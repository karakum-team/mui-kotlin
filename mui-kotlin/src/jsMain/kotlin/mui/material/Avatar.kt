...
external interface AvatarProps :
    AvatarOwnProps, AvatarSlotsAndSlotProps, HTMLAttributes<HTMLDivElement>, PropsWithComponent
...
external interface AvatarSlotProps : Props {
    ...
    /**
     * TS: SlotProps<React.ElementType<SvgIconProps>, AvatarFallbackSlotPropsOverrides,
     * AvatarOwnProps>
     */
...
external interface AvatarOwnProps : PropsWithChildren, PropsWithSx {
    /**
     * Used in combination with `src` or `srcSet` to provide an alt attribute for the rendered `img`
     * element.
     */
    var alt: String?
    ...
    /**
     * The `srcSet` attribute for the `img` element. Use this attribute for responsive image
     * display.
     */
    var srcSet: String?
 ...
 */
@JsName("default") external val Avatar: FC<AvatarProps>
