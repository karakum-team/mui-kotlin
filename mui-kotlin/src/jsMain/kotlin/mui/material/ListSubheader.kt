...
external interface ListSubheaderProps :
    ListSubheaderOwnProps, LiHTMLAttributes<HTMLLIElement>, PropsWithComponent

external interface ListSubheaderOwnProps : PropsWithChildren, PropsWithSx {
 ...
 */
@JsName("default") external val ListSubheader: FC<ListSubheaderProps>
