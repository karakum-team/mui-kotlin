...
external interface CheckboxProps : StandardProps, SwitchBaseProps, PropsWithSx {
    ...
    /**
     * If `true`, the component appears indeterminate. This does not set the native input element to
     * indeterminate due to inconsistent behavior across browsers. However, we set a
     ...
     *   pull out the new checked state by accessing `event.target.checked` (boolean).
     */
...
external interface CheckboxSlotProps : Props {
    /**
     * TS: SlotProps<React.ElementType<SwitchBaseProps>, CheckboxRootSlotPropsOverrides,
     * CheckboxOwnerState>
     */
 ...
 */
@JsName("default") external val Checkbox: FC<CheckboxProps>
