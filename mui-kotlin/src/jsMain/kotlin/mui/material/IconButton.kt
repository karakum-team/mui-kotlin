...
external interface IconButtonOwnProps : PropsWithChildren, PropsWithSx, ButtonBaseProps {
    /** The icon to display. */
    ...
    /**
     * If `true`, the loading indicator is visible and the button is disabled. If `true | false`,
     * the loading wrapper is always rendered before the children to prevent
     * [Google Translation Crash](https://github.com/mui/material-ui/issues/27853).
     *
     * @default null
     */
    var loading: Boolean?
    ...
    /**
     * Element placed before the children if the button is in loading state. The node should contain
     * an element with `role="progressbar"` with an accessible name. By default, it renders a
...
/**
 * Refer to the [Icons](https://mui.com/material-ui/icons/) section of the documentation regarding
 * the available icon options.
 *
 * Demos:
 *
 ...
 */
@JsName("default") external val IconButton: FC<IconButtonProps>
