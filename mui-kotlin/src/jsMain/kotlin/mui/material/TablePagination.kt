...
external interface TablePaginationProps :
    TablePaginationOwnProps, TablePaginationSlotsAndSlotProps, PropsWithComponent
...
external interface TablePaginationSlots {
     ...
     * [Follow this guide](https://mui.com/material-ui/api/table-cell/#props) to learn more about
     ...
     * [Follow this guide](https://mui.com/material-ui/api/toolbar/#props) to learn more about the
     ...
     * [Follow this guide](https://mui.com/material-ui/api/select/#props) to learn more about the
     * requirements for this component.
     *
     * @default Select
     */
    ...
    /**
     * The component that renders the select slot.
     * [Follow this guide](https://mui.com/material-ui/api/menu-item/#props) to learn more about the
     * requirements for this component.
     *
     * @default MenuItem
     */
...
external interface TablePaginationSlotProps : Props {
    /**
     * TS: SlotProps<React.ElementType<TableCellProps>, TablePaginationRootSlotPropsOverrides,
     * TablePaginationOwnerState>
     */
    var root: TableCellProps?

    /**
     * TS: SlotProps<React.ElementType<ToolbarProps>, TablePaginationToolbarSlotPropsOverrides,
     * TablePaginationOwnerState>
     */
    ...
    /**
     * TS: SlotProps<React.ElementType<MenuItemProps>, TablePaginationMenuItemSlotPropsOverrides,
     * TablePaginationOwnerState>
     */
...
external interface TablePaginationOwnProps : TablePaginationBaseProps, PropsWithSx {
    /**
     * The component used for displaying the actions. Either a string to use a HTML element or a
     * component.
     *
     ...
     * [translations](https://mui.com/material-ui/guides/localization/).
     *
     * @default function defaultLabelDisplayedRows({ from, to, count }) { return
     *   `${formatNumber(from)}–${formatNumber(to)} of ${count !== -1 ? formatNumber(count) : `more
     *   than ${formatNumber(to)}`}`; }
     */
 ...
 */
@JsName("default") external val TablePagination: FC<TablePaginationProps>
