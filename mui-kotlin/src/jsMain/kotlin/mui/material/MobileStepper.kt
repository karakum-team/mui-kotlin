...
external interface MobileStepperProps :
    StandardProps, PaperProps, MobileStepperSlotsAndSlotProps, PropsWithSx {
    /**
     * Set the active step (zero based index). Defines which dot is highlighted when the variant is
     * 'dots'.
     *
     * @default 0
     */
...
external interface MobileStepperSlotProps : Props {
    /**
     * TS: SlotProps<React.ElementType<PaperProps>, MobileStepperRootSlotPropsOverrides,
     * MobileStepperOwnerState>
     */
    var root: PaperProps?

    /**
     * TS: SlotProps<React.ElementType<LinearProgressProps>,
     * MobileStepperProgressSlotPropsOverrides, MobileStepperOwnerState>
     */
 ...
 */
@JsName("default") external val MobileStepper: FC<MobileStepperProps>
