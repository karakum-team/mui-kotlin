...
sealed external interface TabsTextColor {
    companion object {
        @JsValue("secondary") val secondary: TabsTextColor
        @JsValue("primary") val primary: TabsTextColor
        @JsValue("inherit") val inherit: TabsTextColor
    }
}

sealed external interface TabsScrollButtons {
    companion object {
        @JsValue("auto") val auto: TabsScrollButtons
        @JsValue("true") val `true`: TabsScrollButtons
        @JsValue("false") val `false`: TabsScrollButtons
    }
}
