...
external interface AccordionSlotProps : Props {
    /**
     * TS: SlotProps<React.ElementType<PaperProps>, AccordionRootSlotPropsOverrides,
     * AccordionOwnerState>
     */
    var root: PaperProps?
     ...
     * AccordionTransitionSlotPropsOverrides, AccordionOwnerState>
     */
...
external interface AccordionOwnProps : PaperProps, PropsWithChildren, PropsWithSx {
    ...
    /**
     * If `true`, it removes the margin between two expanded accordion items and prevents the
    ...
    /**
     * If `true`, expands the accordion, otherwise collapses it. Setting this prop enables control
     * over the accordion.
     */
 ...
 */
@JsName("default") external val Accordion: FC<AccordionProps>
