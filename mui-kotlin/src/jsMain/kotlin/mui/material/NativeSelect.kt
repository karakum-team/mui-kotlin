...
external interface NativeSelectProps : StandardProps, InputProps, PropsWithChildren, PropsWithSx {
    ...
    /**
     * [Attributes](https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/select#attributes)
     ...
     *
     * @param {React.ChangeEvent<HTMLSelectElement>} event The event source of the callback. You can
     *   pull out the new value by accessing `event.target.value` (string).
     */
 ...
 */
@JsName("default") external val NativeSelect: FC<NativeSelectProps>
