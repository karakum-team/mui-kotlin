...
external interface MenuItemProps :
    MenuItemOwnProps, LiHTMLAttributes<HTMLLIElement>, PropsWithComponent

external interface MenuItemOwnProps : PropsWithSx, LiHTMLAttributes<HTMLLIElement> {
    /**
     ...
     * defaults to the value inherited from the parent Menu component.
     *
     * @default false
     */
    var dense: Boolean?
 ...
 */
@JsName("default") external val MenuItem: FC<MenuItemProps>
