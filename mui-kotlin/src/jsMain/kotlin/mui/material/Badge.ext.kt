...
sealed external interface BadgeOriginVertical {
    companion object {
        @JsValue("top") val top: BadgeOriginVertical
        @JsValue("bottom") val bottom: BadgeOriginVertical
    }
}

sealed external interface BadgeOriginHorizontal {
    companion object {
        @JsValue("left") val left: BadgeOriginHorizontal
        @JsValue("right") val right: BadgeOriginHorizontal
    }
}
