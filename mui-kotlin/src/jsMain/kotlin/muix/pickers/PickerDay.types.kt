...
external interface PickerDayProps : ExportedPickerDayProps {
    /** The date to show. */
     ...
     */
    var onKeyDown:
        ((event: react.dom.events.KeyboardEvent<HTMLButtonElement>, day: PickerValidDate) -> Unit)?
     ...
     */
    var onFocus:
        ((event: react.dom.events.FocusEvent<HTMLButtonElement>, day: PickerValidDate) -> Unit)?
...
external interface ExportedPickerDayProps : Props {
     ...
     *
     * - if `fixedWeekNumber` is not defined, renders day to fill the first and last week of the
     *   current month.
     *
