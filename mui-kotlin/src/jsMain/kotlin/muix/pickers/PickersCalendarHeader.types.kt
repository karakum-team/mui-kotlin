...
external interface PickersCalendarHeaderProps : PropsWithClassName, PropsWithSx {
    /**
    ...
    /**
     * Id of the calendar text element. It is used to establish an `aria-labelledby` relationship
     * with the calendar `grid` element.
     */
    var labelId: String?
