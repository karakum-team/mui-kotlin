...
external interface DateCalendarProps : ExportedDateCalendarProps, PropsWithClassName, PropsWithSx {
     ...
     *
     * @default The closest valid date using the validation props, except callbacks such as
     *   `shouldDisableDate`.
     */
...
external interface DateCalendarSlots :
    PickersCalendarHeaderSlots, DayCalendarSlots, MonthCalendarSlots, YearCalendarSlots {
    /**
     * Custom component for calendar header. Check the
     * [PickersCalendarHeader](https://mui.com/x/api/date-pickers/pickers-calendar-header/)
     * component.
     *
...
external interface ExportedDateCalendarProps :
    ExportedDayCalendarProps, ExportedMonthCalendarProps, ExportedValidateDateProps {
    /**
     * If `true`, disable heavy animations.
     *
     * @default `@media(prefers-reduced-motion: reduce)` || `navigator.userAgent` matches Android
     *   <10 or iOS <13
     */
