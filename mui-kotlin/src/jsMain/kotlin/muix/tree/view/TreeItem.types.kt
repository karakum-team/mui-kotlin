...
external interface TreeItemProps : UseTreeItemParameters, PropsWithClassName, PropsWithSx {
    ...
    /**
     * This prop isn't supported. Use the `onItemFocus` callback on the tree if you need to monitor
     * an item's focus.
     */
    @Deprecated("See documentation") var onFocus: FocusEventHandler<HTMLLIElement>?
...
external interface TreeItemSlots : TreeItemIconSlots {
    ...
    /**
     * The component that renders the content of the item. (e.g.: everything related to this item,
     * not to its children).
     *
    ...
    /**
     * The component that renders the input to edit the label when the item is editable and is
    ...
    /**
     * The component that renders the overlay when an item reordering is ongoing. Warning: This slot
     * is only useful when using the `<RichTreeViewPro />` component.
     *
    ...
    /**
     * The component that is rendered when the item is in an error state. Warning: This slot is only
     * useful when using the `<RichTreeViewPro />` component is lazy loading is enabled.
     *
    ...
    /**
     * The component that is rendered when the item is in a loading state. Warning: This slot is
     * only useful when using the `<RichTreeViewPro />` component is lazy loading is enabled.
     *
...
external interface TreeItemSlotProps : TreeItemIconSlotProps {
    var root: Props?
