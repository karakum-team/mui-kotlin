...
/**
 * The state-dependent arm of `FieldRootProps.className`, upstream `string | ((state:
 * FieldRootState) => string | undefined)`.
 *
 ...
 */
fun FieldRootProps.className(block: (state: FieldRootState) -> ClassName?) {
    className = block
}

/**
 * The state-dependent arm of `FieldRootProps.style`, upstream `CSSProperties | ((state:
 * FieldRootState) => CSSProperties | undefined)`. See [FieldRootProps.className].
 */
fun FieldRootProps.style(block: (state: FieldRootState) -> CSSProperties?) {
    style = block
}

/**
 * The callback arm of `FieldRootProps.render`, upstream `ReactElement | ((props: HTMLProps, state:
 * FieldRootState) => ReactElement)`.
 *
 ...
 */
fun FieldRootProps.render(
    block: (props: HTMLAttributes<HTMLElement>, state: FieldRootState) -> ReactElement<*>
) {
    render = block
}
