...
/**
 * The state-dependent arm of `MenuPopupProps.className`, upstream `string | ((state:
 * MenuPopupState) => string | undefined)`.
 *
 ...
 */
fun MenuPopupProps.className(block: (state: MenuPopupState) -> ClassName?) {
    className = block
}

/**
 * The state-dependent arm of `MenuPopupProps.style`, upstream `CSSProperties | ((state:
 * MenuPopupState) => CSSProperties | undefined)`. See [MenuPopupProps.className].
 */
fun MenuPopupProps.style(block: (state: MenuPopupState) -> CSSProperties?) {
    style = block
}

/**
 * The callback arm of `MenuPopupProps.render`, upstream `ReactElement | ((props: HTMLProps, state:
 * MenuPopupState) => ReactElement)`.
 *
 ...
 */
fun MenuPopupProps.render(
    block: (props: HTMLAttributes<HTMLElement>, state: MenuPopupState) -> ReactElement<*>
) {
    render = block
}
