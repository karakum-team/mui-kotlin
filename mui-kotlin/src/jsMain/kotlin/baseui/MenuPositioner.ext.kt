...
/**
 * The state-dependent arm of `MenuPositionerProps.className`, upstream `string | ((state:
 * MenuPositionerState) => string | undefined)`.
 *
 ...
 * depend on state.
 */
fun MenuPositionerProps.className(block: (state: MenuPositionerState) -> ClassName?) {
    className = block
}

/**
 * The state-dependent arm of `MenuPositionerProps.style`, upstream `CSSProperties | ((state:
 * MenuPositionerState) => CSSProperties | undefined)`. See [MenuPositionerProps.className].
 */
fun MenuPositionerProps.style(block: (state: MenuPositionerState) -> CSSProperties?) {
    style = block
}

/**
 * The callback arm of `MenuPositionerProps.render`, upstream `ReactElement | ((props: HTMLProps,
 * state: MenuPositionerState) => ReactElement)`.
 *
