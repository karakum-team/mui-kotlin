...
/**
 * The state-dependent arm of `MenuRadioGroupProps.className`, upstream
 ...
 */
fun MenuRadioGroupProps.className(
    block: (state: MenuRadioGroupState) -> ClassName?,
) {
    className = block
}

/**
 * The state-dependent arm of `MenuRadioGroupProps.style`, upstream
 * `CSSProperties | ((state: MenuRadioGroupState) => CSSProperties | undefined)`. See [MenuRadioGroupProps.className].
 */
fun MenuRadioGroupProps.style(
    block: (state: MenuRadioGroupState) -> CSSProperties?,
) {
    style = block
}

/**
 * The callback arm of `MenuRadioGroupProps.render`, upstream
 * `ReactElement | ((props: HTMLProps, state: MenuRadioGroupState) => ReactElement)`.
 *
