...
/**
 * The state-dependent arm of `NumberFieldIncrementProps.className`, upstream
 * `string | ((state: NumberFieldIncrementState) => string | undefined)`.
 *
 ...
 */
fun NumberFieldIncrementProps.className(
    block: (state: NumberFieldIncrementState) -> ClassName?,
) {
    className = block
}

/**
 * The state-dependent arm of `NumberFieldIncrementProps.style`, upstream
 * `CSSProperties | ((state: NumberFieldIncrementState) => CSSProperties | undefined)`. See [NumberFieldIncrementProps.className].
 */
fun NumberFieldIncrementProps.style(
    block: (state: NumberFieldIncrementState) -> CSSProperties?,
) {
    style = block
}

/**
 * The callback arm of `NumberFieldIncrementProps.render`, upstream
 * `ReactElement | ((props: HTMLProps, state: NumberFieldIncrementState) => ReactElement)`.
 *
 ...
 */
fun NumberFieldIncrementProps.render(
    block: (props: HTMLAttributes<HTMLElement>, state: NumberFieldIncrementState) -> ReactElement<*>,
) {
    render = block
}
