...
external interface MenuRadioItemProps : NonNativeButtonProps, BaseUiDivProps {
    /**
     * Value of the radio item. This is the value that will be set in the MenuRadioGroup when the
     * item is selected.
     */
    var value: Any
