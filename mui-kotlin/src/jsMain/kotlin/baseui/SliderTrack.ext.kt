...
/**
 * The state-dependent arm of `SliderTrackProps.className`, upstream `string | ((state:
 * SliderTrackState) => string | undefined)`.
 *
 ...
 */
fun SliderTrackProps.className(block: (state: SliderTrackState) -> ClassName?) {
    className = block
}

/**
 * The state-dependent arm of `SliderTrackProps.style`, upstream `CSSProperties | ((state:
 * SliderTrackState) => CSSProperties | undefined)`. See [SliderTrackProps.className].
 */
fun SliderTrackProps.style(block: (state: SliderTrackState) -> CSSProperties?) {
    style = block
}

/**
 * The callback arm of `SliderTrackProps.render`, upstream `ReactElement | ((props: HTMLProps,
 * state: SliderTrackState) => ReactElement)`.
 *
