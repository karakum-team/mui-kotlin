...
/**
 * The state-dependent arm of `AccordionTriggerProps.className`, upstream
 * `string | ((state: AccordionTriggerState) => string | undefined)`.
 *
 ...
 */
fun AccordionTriggerProps.className(
    block: (state: AccordionTriggerState) -> ClassName?,
) {
    className = block
}

/**
 * The state-dependent arm of `AccordionTriggerProps.style`, upstream
 * `CSSProperties | ((state: AccordionTriggerState) => CSSProperties | undefined)`. See [AccordionTriggerProps.className].
 */
fun AccordionTriggerProps.style(
    block: (state: AccordionTriggerState) -> CSSProperties?,
) {
    style = block
}

/**
 * The callback arm of `AccordionTriggerProps.render`, upstream
 * `ReactElement | ((props: HTMLProps, state: AccordionTriggerState) => ReactElement)`.
 *
 ...
 */
fun AccordionTriggerProps.render(
    block: (props: HTMLAttributes<HTMLElement>, state: AccordionTriggerState) -> ReactElement<*>,
) {
    render = block
}
