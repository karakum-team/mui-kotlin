...
/**
 * The state-dependent arm of `NumberFieldRootProps.className`, upstream
 * `string | ((state: NumberFieldRootState) => string | undefined)`.
 *
 ...
 */
fun NumberFieldRootProps.className(
    block: (state: NumberFieldRootState) -> ClassName?,
) {
    className = block
}

/**
 * The state-dependent arm of `NumberFieldRootProps.style`, upstream
 * `CSSProperties | ((state: NumberFieldRootState) => CSSProperties | undefined)`. See [NumberFieldRootProps.className].
 */
fun NumberFieldRootProps.style(
    block: (state: NumberFieldRootState) -> CSSProperties?,
) {
    style = block
}

/**
 * The callback arm of `NumberFieldRootProps.render`, upstream
 * `ReactElement | ((props: HTMLProps, state: NumberFieldRootState) => ReactElement)`.
 *
 ...
 */
fun NumberFieldRootProps.render(
    block: (props: HTMLAttributes<HTMLElement>, state: NumberFieldRootState) -> ReactElement<*>,
) {
    render = block
}
