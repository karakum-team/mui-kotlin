...
/**
 * The state-dependent arm of `SliderThumbProps.className`, upstream `string | ((state:
 * SliderThumbState) => string | undefined)`.
 *
 ...
 */
fun SliderThumbProps.className(block: (state: SliderThumbState) -> ClassName?) {
    className = block
}

/**
 * The state-dependent arm of `SliderThumbProps.style`, upstream `CSSProperties | ((state:
 * SliderThumbState) => CSSProperties | undefined)`. See [SliderThumbProps.className].
 */
fun SliderThumbProps.style(block: (state: SliderThumbState) -> CSSProperties?) {
    style = block
}

/**
 * The callback arm of `SliderThumbProps.render`, upstream `ReactElement | ((props: HTMLProps,
 * state: SliderThumbState) => ReactElement)`.
 *
 ...
 */
fun SliderThumbProps.render(
    block: (props: HTMLAttributes<HTMLElement>, state: SliderThumbState) -> ReactElement<*>
) {
    render = block
}
