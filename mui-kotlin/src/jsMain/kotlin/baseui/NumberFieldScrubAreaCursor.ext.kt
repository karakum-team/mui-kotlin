...
/**
 * The state-dependent arm of `NumberFieldScrubAreaCursorProps.className`, upstream
 * `string | ((state: NumberFieldScrubAreaCursorState) => string | undefined)`.
 *
 ...
 */
fun NumberFieldScrubAreaCursorProps.className(
    block: (state: NumberFieldScrubAreaCursorState) -> ClassName?,
) {
    className = block
}

/**
 * The state-dependent arm of `NumberFieldScrubAreaCursorProps.style`, upstream
 * `CSSProperties | ((state: NumberFieldScrubAreaCursorState) => CSSProperties | undefined)`. See [NumberFieldScrubAreaCursorProps.className].
 */
fun NumberFieldScrubAreaCursorProps.style(
    block: (state: NumberFieldScrubAreaCursorState) -> CSSProperties?,
) {
    style = block
}

/**
 * The callback arm of `NumberFieldScrubAreaCursorProps.render`, upstream
 * `ReactElement | ((props: HTMLProps, state: NumberFieldScrubAreaCursorState) => ReactElement)`.
 *
 ...
 */
fun NumberFieldScrubAreaCursorProps.render(
    block: (props: HTMLAttributes<HTMLElement>, state: NumberFieldScrubAreaCursorState) -> ReactElement<*>,
) {
    render = block
}
