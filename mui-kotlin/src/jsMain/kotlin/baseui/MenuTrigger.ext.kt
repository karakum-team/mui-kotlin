...
/**
 * The state-dependent arm of `MenuTriggerProps.className`, upstream
 ...
 */
fun MenuTriggerProps.className(
    block: (state: MenuTriggerState) -> ClassName?,
) {
    className = block
}

/**
 * The state-dependent arm of `MenuTriggerProps.style`, upstream
 * `CSSProperties | ((state: MenuTriggerState) => CSSProperties | undefined)`. See [MenuTriggerProps.className].
 */
fun MenuTriggerProps.style(
    block: (state: MenuTriggerState) -> CSSProperties?,
) {
    style = block
}

/**
 * The callback arm of `MenuTriggerProps.render`, upstream
 * `ReactElement | ((props: HTMLProps, state: MenuTriggerState) => ReactElement)`.
 *
