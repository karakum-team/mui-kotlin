...
/**
 * The state-dependent arm of `MenuGroupLabelProps.className`, upstream
 ...
 */
fun MenuGroupLabelProps.className(
    block: (state: MenuGroupLabelState) -> ClassName?,
) {
    className = block
}

/**
 * The state-dependent arm of `MenuGroupLabelProps.style`, upstream
 * `CSSProperties | ((state: MenuGroupLabelState) => CSSProperties | undefined)`. See [MenuGroupLabelProps.className].
 */
fun MenuGroupLabelProps.style(
    block: (state: MenuGroupLabelState) -> CSSProperties?,
) {
    style = block
}

/**
 * The callback arm of `MenuGroupLabelProps.render`, upstream
 * `ReactElement | ((props: HTMLProps, state: MenuGroupLabelState) => ReactElement)`.
 *
