...
/**
 * The state-dependent arm of `MenuSubmenuTriggerProps.className`, upstream
 ...
 */
fun MenuSubmenuTriggerProps.className(
    block: (state: MenuSubmenuTriggerState) -> ClassName?,
) {
    className = block
}

/**
 * The state-dependent arm of `MenuSubmenuTriggerProps.style`, upstream
 * `CSSProperties | ((state: MenuSubmenuTriggerState) => CSSProperties | undefined)`. See [MenuSubmenuTriggerProps.className].
 */
fun MenuSubmenuTriggerProps.style(
    block: (state: MenuSubmenuTriggerState) -> CSSProperties?,
) {
    style = block
}

/**
 * The callback arm of `MenuSubmenuTriggerProps.render`, upstream
 * `ReactElement | ((props: HTMLProps, state: MenuSubmenuTriggerState) => ReactElement)`.
 *
