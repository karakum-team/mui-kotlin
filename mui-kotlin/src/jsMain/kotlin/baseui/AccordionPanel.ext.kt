...
/**
 * The state-dependent arm of `AccordionPanelProps.className`, upstream
 * `string | ((state: AccordionPanelState) => string | undefined)`.
 *
 ...
 */
fun AccordionPanelProps.className(
    block: (state: AccordionPanelState) -> ClassName?,
) {
    className = block
}

/**
 * The state-dependent arm of `AccordionPanelProps.style`, upstream
 * `CSSProperties | ((state: AccordionPanelState) => CSSProperties | undefined)`. See [AccordionPanelProps.className].
 */
fun AccordionPanelProps.style(
    block: (state: AccordionPanelState) -> CSSProperties?,
) {
    style = block
}

/**
 * The callback arm of `AccordionPanelProps.render`, upstream
 * `ReactElement | ((props: HTMLProps, state: AccordionPanelState) => ReactElement)`.
 *
 ...
 */
fun AccordionPanelProps.render(
    block: (props: HTMLAttributes<HTMLElement>, state: AccordionPanelState) -> ReactElement<*>,
) {
    render = block
}
