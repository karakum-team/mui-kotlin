...
/**
 * The state-dependent arm of `MenuCheckboxItemProps.className`, upstream
 ...
 */
fun MenuCheckboxItemProps.className(
    block: (state: MenuCheckboxItemState) -> ClassName?,
) {
    className = block
}

/**
 * The state-dependent arm of `MenuCheckboxItemProps.style`, upstream
 * `CSSProperties | ((state: MenuCheckboxItemState) => CSSProperties | undefined)`. See [MenuCheckboxItemProps.className].
 */
fun MenuCheckboxItemProps.style(
    block: (state: MenuCheckboxItemState) -> CSSProperties?,
) {
    style = block
}

/**
 * The callback arm of `MenuCheckboxItemProps.render`, upstream
 * `ReactElement | ((props: HTMLProps, state: MenuCheckboxItemState) => ReactElement)`.
 *
