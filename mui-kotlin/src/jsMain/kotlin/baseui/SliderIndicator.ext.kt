...
/**
 * The state-dependent arm of `SliderIndicatorProps.className`, upstream
 ...
 */
fun SliderIndicatorProps.className(
    block: (state: SliderIndicatorState) -> ClassName?,
) {
    className = block
}

/**
 * The state-dependent arm of `SliderIndicatorProps.style`, upstream
 * `CSSProperties | ((state: SliderIndicatorState) => CSSProperties | undefined)`. See [SliderIndicatorProps.className].
 */
fun SliderIndicatorProps.style(
    block: (state: SliderIndicatorState) -> CSSProperties?,
) {
    style = block
}

/**
 * The callback arm of `SliderIndicatorProps.render`, upstream
 * `ReactElement | ((props: HTMLProps, state: SliderIndicatorState) => ReactElement)`.
 *
