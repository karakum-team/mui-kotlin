...
/**
 * The state-dependent arm of `NumberFieldInputProps.className`, upstream
 * `string | ((state: NumberFieldInputState) => string | undefined)`.
 *
 ...
 */
fun NumberFieldInputProps.className(
    block: (state: NumberFieldInputState) -> ClassName?,
) {
    className = block
}

/**
 * The state-dependent arm of `NumberFieldInputProps.style`, upstream
 * `CSSProperties | ((state: NumberFieldInputState) => CSSProperties | undefined)`. See [NumberFieldInputProps.className].
 */
fun NumberFieldInputProps.style(
    block: (state: NumberFieldInputState) -> CSSProperties?,
) {
    style = block
}

/**
 * The callback arm of `NumberFieldInputProps.render`, upstream
 * `ReactElement | ((props: HTMLProps, state: NumberFieldInputState) => ReactElement)`.
 *
 ...
 */
fun NumberFieldInputProps.render(
    block: (props: HTMLAttributes<HTMLElement>, state: NumberFieldInputState) -> ReactElement<*>,
) {
    render = block
}
