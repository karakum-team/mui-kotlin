...
/**
 * The state-dependent arm of `SliderLabelProps.className`, upstream
 * `string | ((state: SliderLabelState) => string | undefined)`.
 *
 ...
 */
fun SliderLabelProps.className(
    block: (state: SliderLabelState) -> ClassName?,
) {
    className = block
}

/**
 * The state-dependent arm of `SliderLabelProps.style`, upstream
 * `CSSProperties | ((state: SliderLabelState) => CSSProperties | undefined)`. See [SliderLabelProps.className].
 */
fun SliderLabelProps.style(
    block: (state: SliderLabelState) -> CSSProperties?,
) {
    style = block
}

/**
 * The callback arm of `SliderLabelProps.render`, upstream
 * `ReactElement | ((props: HTMLProps, state: SliderLabelState) => ReactElement)`.
 *
