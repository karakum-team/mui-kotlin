...
/**
 * The state-dependent arm of `MenuRadioItemIndicatorProps.className`, upstream
 * `string | ((state: MenuRadioItemIndicatorState) => string | undefined)`.
 *
...
/**
 * The state-dependent arm of `MenuRadioItemIndicatorProps.style`, upstream
 * `CSSProperties | ((state: MenuRadioItemIndicatorState) => CSSProperties | undefined)`. See [MenuRadioItemIndicatorProps.className].
 */
...
/**
 * The callback arm of `MenuRadioItemIndicatorProps.render`, upstream
 * `ReactElement | ((props: HTMLProps, state: MenuRadioItemIndicatorState) => ReactElement)`.
 *
...
fun MenuRadioItemIndicatorProps.render(
    block: (props: HTMLAttributes<HTMLElement>, state: MenuRadioItemIndicatorState) -> ReactElement<*>,
) {
    render = block
}
