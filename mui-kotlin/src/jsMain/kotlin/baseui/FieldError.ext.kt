...
/**
 * The state-dependent arm of `FieldErrorProps.className`, upstream
 ...
 */
fun FieldErrorProps.className(
    block: (state: FieldErrorState) -> ClassName?,
) {
    className = block
}

/**
 * The state-dependent arm of `FieldErrorProps.style`, upstream
 * `CSSProperties | ((state: FieldErrorState) => CSSProperties | undefined)`. See [FieldErrorProps.className].
 */
fun FieldErrorProps.style(
    block: (state: FieldErrorState) -> CSSProperties?,
) {
    style = block
}

/**
 * The callback arm of `FieldErrorProps.render`, upstream
 * `ReactElement | ((props: HTMLProps, state: FieldErrorState) => ReactElement)`.
 *
 ...
 */
fun FieldErrorProps.render(
    block: (props: HTMLAttributes<HTMLElement>, state: FieldErrorState) -> ReactElement<*>,
) {
    render = block
}
