...
/**
 * The state-dependent arm of `NumberFieldDecrementProps.className`, upstream
 * `string | ((state: NumberFieldDecrementState) => string | undefined)`.
 *
 ...
 */
fun NumberFieldDecrementProps.className(
    block: (state: NumberFieldDecrementState) -> ClassName?,
) {
    className = block
}

/**
 * The state-dependent arm of `NumberFieldDecrementProps.style`, upstream
 * `CSSProperties | ((state: NumberFieldDecrementState) => CSSProperties | undefined)`. See [NumberFieldDecrementProps.className].
 */
fun NumberFieldDecrementProps.style(
    block: (state: NumberFieldDecrementState) -> CSSProperties?,
) {
    style = block
}

/**
 * The callback arm of `NumberFieldDecrementProps.render`, upstream
 * `ReactElement | ((props: HTMLProps, state: NumberFieldDecrementState) => ReactElement)`.
 *
 ...
 */
fun NumberFieldDecrementProps.render(
    block: (props: HTMLAttributes<HTMLElement>, state: NumberFieldDecrementState) -> ReactElement<*>,
) {
    render = block
}
