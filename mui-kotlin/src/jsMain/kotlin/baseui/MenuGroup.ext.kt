...
/**
 * The state-dependent arm of `MenuGroupProps.className`, upstream
 ...
 */
fun MenuGroupProps.className(
    block: (state: MenuGroupState) -> ClassName?,
) {
    className = block
}

/**
 * The state-dependent arm of `MenuGroupProps.style`, upstream
 * `CSSProperties | ((state: MenuGroupState) => CSSProperties | undefined)`. See [MenuGroupProps.className].
 */
fun MenuGroupProps.style(
    block: (state: MenuGroupState) -> CSSProperties?,
) {
    style = block
}

/**
 * The callback arm of `MenuGroupProps.render`, upstream
 * `ReactElement | ((props: HTMLProps, state: MenuGroupState) => ReactElement)`.
 *
