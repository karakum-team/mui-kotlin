...
/**
 * The state-dependent arm of `AccordionRootProps.className`, upstream
 * `string | ((state: AccordionRootState) => string | undefined)`.
 *
 ...
 */
fun AccordionRootProps.className(
    block: (state: AccordionRootState) -> ClassName?,
) {
    className = block
}

/**
 * The state-dependent arm of `AccordionRootProps.style`, upstream
 * `CSSProperties | ((state: AccordionRootState) => CSSProperties | undefined)`. See [AccordionRootProps.className].
 */
fun AccordionRootProps.style(
    block: (state: AccordionRootState) -> CSSProperties?,
) {
    style = block
}

/**
 * The callback arm of `AccordionRootProps.render`, upstream
 * `ReactElement | ((props: HTMLProps, state: AccordionRootState) => ReactElement)`.
 *
 ...
 */
fun AccordionRootProps.render(
    block: (props: HTMLAttributes<HTMLElement>, state: AccordionRootState) -> ReactElement<*>,
) {
    render = block
}
