...
/**
 * The state-dependent arm of `SliderRootProps.className`, upstream
 ...
 */
fun SliderRootProps.className(
    block: (state: SliderRootState) -> ClassName?,
) {
    className = block
}

/**
 * The state-dependent arm of `SliderRootProps.style`, upstream
 * `CSSProperties | ((state: SliderRootState) => CSSProperties | undefined)`. See [SliderRootProps.className].
 */
fun SliderRootProps.style(
    block: (state: SliderRootState) -> CSSProperties?,
) {
    style = block
}

/**
 * The callback arm of `SliderRootProps.render`, upstream
 * `ReactElement | ((props: HTMLProps, state: SliderRootState) => ReactElement)`.
 *
