...
/**
 * The state-dependent arm of `FieldItemProps.className`, upstream
 * `string | ((state: FieldItemState) => string | undefined)`.
 *
 ...
 */
fun FieldItemProps.className(
    block: (state: FieldItemState) -> ClassName?,
) {
    className = block
}

/**
 * The state-dependent arm of `FieldItemProps.style`, upstream
 * `CSSProperties | ((state: FieldItemState) => CSSProperties | undefined)`. See [FieldItemProps.className].
 */
fun FieldItemProps.style(
    block: (state: FieldItemState) -> CSSProperties?,
) {
    style = block
}

/**
 * The callback arm of `FieldItemProps.render`, upstream
 * `ReactElement | ((props: HTMLProps, state: FieldItemState) => ReactElement)`.
 *
 ...
 */
fun FieldItemProps.render(
    block: (props: HTMLAttributes<HTMLElement>, state: FieldItemState) -> ReactElement<*>,
) {
    render = block
}
