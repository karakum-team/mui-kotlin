...
/**
 * The state-dependent arm of `CollapsibleRootProps.className`, upstream
 * `string | ((state: CollapsibleRootState) => string | undefined)`.
 *
 ...
 */
fun CollapsibleRootProps.className(
    block: (state: CollapsibleRootState) -> ClassName?,
) {
    className = block
}

/**
 * The state-dependent arm of `CollapsibleRootProps.style`, upstream
 * `CSSProperties | ((state: CollapsibleRootState) => CSSProperties | undefined)`. See [CollapsibleRootProps.className].
 */
fun CollapsibleRootProps.style(
    block: (state: CollapsibleRootState) -> CSSProperties?,
) {
    style = block
}

/**
 * The callback arm of `CollapsibleRootProps.render`, upstream
 * `ReactElement | ((props: HTMLProps, state: CollapsibleRootState) => ReactElement)`.
 *
 ...
 */
fun CollapsibleRootProps.render(
    block: (props: HTMLAttributes<HTMLElement>, state: CollapsibleRootState) -> ReactElement<*>,
) {
    render = block
}
