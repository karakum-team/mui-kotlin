...
/**
 * The state-dependent arm of `NumberFieldGroupProps.className`, upstream
 * `string | ((state: NumberFieldGroupState) => string | undefined)`.
 *
 ...
 */
fun NumberFieldGroupProps.className(
    block: (state: NumberFieldGroupState) -> ClassName?,
) {
    className = block
}

/**
 * The state-dependent arm of `NumberFieldGroupProps.style`, upstream
 * `CSSProperties | ((state: NumberFieldGroupState) => CSSProperties | undefined)`. See [NumberFieldGroupProps.className].
 */
fun NumberFieldGroupProps.style(
    block: (state: NumberFieldGroupState) -> CSSProperties?,
) {
    style = block
}

/**
 * The callback arm of `NumberFieldGroupProps.render`, upstream
 * `ReactElement | ((props: HTMLProps, state: NumberFieldGroupState) => ReactElement)`.
 *
 ...
 */
fun NumberFieldGroupProps.render(
    block: (props: HTMLAttributes<HTMLElement>, state: NumberFieldGroupState) -> ReactElement<*>,
) {
    render = block
}
