...
/**
 * The state-dependent arm of `AccordionItemProps.className`, upstream
 * `string | ((state: AccordionItemState) => string | undefined)`.
 *
 ...
 */
fun AccordionItemProps.className(
    block: (state: AccordionItemState) -> ClassName?,
) {
    className = block
}

/**
 * The state-dependent arm of `AccordionItemProps.style`, upstream
 * `CSSProperties | ((state: AccordionItemState) => CSSProperties | undefined)`. See [AccordionItemProps.className].
 */
fun AccordionItemProps.style(
    block: (state: AccordionItemState) -> CSSProperties?,
) {
    style = block
}

/**
 * The callback arm of `AccordionItemProps.render`, upstream
 * `ReactElement | ((props: HTMLProps, state: AccordionItemState) => ReactElement)`.
 *
 ...
 */
fun AccordionItemProps.render(
    block: (props: HTMLAttributes<HTMLElement>, state: AccordionItemState) -> ReactElement<*>,
) {
    render = block
}
