...
external interface SliderThumbProps : BaseUiDivProps {
    /**
    ...
    /**
     * A string value forwarded to the
     * [`aria-valuetext`](https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA/Reference/Attributes/aria-valuetext)
     * attribute of the `input`. Ignored when `getAriaValueText` is provided.
     */
    @JsName("aria-valuetext") var ariaValueText: Any? /* React.AriaAttributes['aria-valuetext'] */
     ...
     * A function which returns a string value for the
     * [`aria-valuetext`](https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA/Reference/Attributes/aria-valuetext)
     * attribute of the `input`. This is important for screen reader users.
     */
