...
/**
 * The state-dependent arm of `SliderControlProps.className`, upstream
 ...
 */
fun SliderControlProps.className(
    block: (state: SliderControlState) -> ClassName?,
) {
    className = block
}

/**
 * The state-dependent arm of `SliderControlProps.style`, upstream
 * `CSSProperties | ((state: SliderControlState) => CSSProperties | undefined)`. See [SliderControlProps.className].
 */
fun SliderControlProps.style(
    block: (state: SliderControlState) -> CSSProperties?,
) {
    style = block
}

/**
 * The callback arm of `SliderControlProps.render`, upstream
 * `ReactElement | ((props: HTMLProps, state: SliderControlState) => ReactElement)`.
 *
