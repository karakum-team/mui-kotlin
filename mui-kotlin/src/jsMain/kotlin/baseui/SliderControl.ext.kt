...
/**
 * The state-dependent arm of `SliderControlProps.className`, upstream `string | ((state:
 * SliderControlState) => string | undefined)`.
 *
 ...
 */
fun SliderControlProps.className(block: (state: SliderControlState) -> ClassName?) {
    className = block
}

/**
 * The state-dependent arm of `SliderControlProps.style`, upstream `CSSProperties | ((state:
 * SliderControlState) => CSSProperties | undefined)`. See [SliderControlProps.className].
 */
fun SliderControlProps.style(block: (state: SliderControlState) -> CSSProperties?) {
    style = block
}

/**
 * The callback arm of `SliderControlProps.render`, upstream `ReactElement | ((props: HTMLProps,
 * state: SliderControlState) => ReactElement)`.
 *
 ...
 */
fun SliderControlProps.render(
    block: (props: HTMLAttributes<HTMLElement>, state: SliderControlState) -> ReactElement<*>
) {
    render = block
}
