...
/**
 * The state-dependent arm of `MenuRadioItemProps.className`, upstream
 ...
 */
fun MenuRadioItemProps.className(
    block: (state: MenuRadioItemState) -> ClassName?,
) {
    className = block
}

/**
 * The state-dependent arm of `MenuRadioItemProps.style`, upstream
 * `CSSProperties | ((state: MenuRadioItemState) => CSSProperties | undefined)`. See [MenuRadioItemProps.className].
 */
fun MenuRadioItemProps.style(
    block: (state: MenuRadioItemState) -> CSSProperties?,
) {
    style = block
}

/**
 * The callback arm of `MenuRadioItemProps.render`, upstream
 * `ReactElement | ((props: HTMLProps, state: MenuRadioItemState) => ReactElement)`.
 *
